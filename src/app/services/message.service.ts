...
export class MessageService {
  // db url for local
  // private dbUrl = 'http://localhost:4000/messages';

  //db url for backend deployed on heroku
  private dbUrl = 'https://test-the-milk.herokuapp.com/messages';
  currentUserId = this.getUserId(); //used as a param for get messages route, getting messages for loged in user
